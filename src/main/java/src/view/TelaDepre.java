 ...
 * @author gabriel
 */
public class TelaDepre extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDepre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
